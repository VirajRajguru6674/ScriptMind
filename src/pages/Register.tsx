...
import { Eye, EyeOff, Mail, Sparkles, Youtube, BookOpen, Brain, Zap, User, UserPlus, Github } from "lucide-react";
                ...
                <div className="w-full max-w-[440px] relative z-10 space-y-12 animate-in fade-in slide-in-from-right-8 duration-700">
                    ...
                    <div className="space-y-4">
                        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-primary/10 border border-primary/20 text-[10px] font-black text-primary uppercase tracking-widest leading-none">
                            <UserPlus className="size-3" /> Get Started
                        </div>
                        <h1 className="text-5xl font-black tracking-tight text-white">Join the <span className="text-primary">genius</span> squad.</h1>
                        <p className="text-muted-foreground text-lg leading-relaxed">Create an account to start summarizing and learning like never before.</p>
                    </div>
                    ...
                    <form onSubmit={handleRegister} className="space-y-6">
                        ...
                        <Button type="submit" className="w-full h-14 rounded-2xl text-lg font-black bg-primary hover:bg-primary/90 text-white shadow-[0_10px_30px_rgba(var(--primary),0.3)] hover:shadow-[0_15px_40px_rgba(var(--primary),0.4)] transition-all active:scale-[0.98] group" disabled={isLoading}>
                            {isLoading ? (
                                ...
                                <div className="flex items-center justify-center gap-2">
                                    Create Free Account <Zap className="size-4 text-yellow-300 group-hover:scale-125 transition-transform" />
                                </div>
                            )}
                        </Button>
