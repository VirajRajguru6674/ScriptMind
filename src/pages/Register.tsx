            ...
            <div className="flex-1 flex items-center justify-center p-4 sm:p-8 relative min-h-screen overflow-y-auto">
                ...
                <div className="w-full max-w-[430px] bg-black/70 backdrop-blur-xl border border-white/10 px-6 py-5 sm:px-10 sm:py-8 rounded-[28px] shadow-2xl relative z-10 space-y-5 animate-in fade-in slide-in-from-bottom-8 duration-700">
                    ...
                    <div className="space-y-3 text-center">
                        ...
                        <h1 className="text-4xl sm:text-5xl font-black tracking-widest text-white uppercase mt-2">Sign Up</h1>
                    ...
                    <form onSubmit={handleRegister} className="space-y-5">
                        ...
                        <div className="relative flex items-center justify-center my-4">
                            ...
                            <span className="relative px-4 bg-[#111317] rounded-full border border-white/10 text-[10px] font-black text-muted-foreground/80 uppercase tracking-widest z-10">or register with</span>
                        </div>
