...
const Register = () => {
    ...
    return (
        <div className="min-h-screen flex items-stretch bg-[#0F1115] overflow-hidden selection:bg-primary/30">
            ...
            <div className="flex-1 flex items-center justify-center p-4 sm:p-8 relative min-h-screen overflow-y-auto bg-[#0F1115]">
                {/* Generated Background Image - Mobile Only */}
                <div 
                    className="absolute inset-0 bg-cover bg-center pointer-events-none opacity-85 lg:hidden"
                    style={{ backgroundImage: `url('/login-bg.png')` }}
                />
                {/* Hex/Grid overlay texture for depth - Mobile Only */}
                <div className="absolute inset-0 bg-black/45 backdrop-blur-[3px] pointer-events-none lg:hidden" />
                
                {/* Grid pattern - Desktop Only */}
                <div className="absolute inset-0 bg-grid-white/[0.02] pointer-events-none hidden lg:block" />
                ...
                <div className="hidden lg:block w-full max-w-[440px] relative z-10 space-y-12 animate-in fade-in slide-in-from-right-8 duration-700">
                    <div className="space-y-4">
                        ...
                        <p className="text-muted-foreground text-lg leading-relaxed">Join the genius squad.</p>
                    </div>

                    <form onSubmit={handleRegister} className="space-y-6">
                        <div className="space-y-3 group">
                            <Label htmlFor="desktop-username" className="text-xs font-bold uppercase tracking-widest text-muted-foreground transition-colors group-focus-within:text-primary">Full Name</Label>
                            <div className="relative">
                                ...
                                />
                                <User className="absolute right-5 top-1/2 -translate-y-1/2 size-5 text-muted-foreground/30" />
                            </div>
                        </div>

                        <div className="space-y-3 group">
                            <Label htmlFor="desktop-email" className="text-xs font-bold uppercase tracking-widest text-muted-foreground transition-colors group-focus-within:text-primary">Email Address</Label>
                            <div className="relative">
                                <Input
                                    id="desktop-email"
                                    type="email"
                        ...
                        <div className="space-y-3 group">
                            <Label htmlFor="desktop-password" className="text-xs font-bold uppercase tracking-widest text-muted-foreground transition-colors group-focus-within:text-primary">Choose Password</Label>
                            <div className="relative">
                                <Input
                                    id="desktop-password"
                        ...
                        <div className="space-y-3 group">
                            <Label htmlFor="desktop-confirmPassword" className="text-xs font-bold uppercase tracking-widest text-muted-foreground transition-colors group-focus-within:text-primary">Confirm Password</Label>
                            <div className="relative">
                                <Input
                                    ...
                                    className="h-14 bg-[#16181D] border-white/5 rounded-2xl focus:border-primary/50 focus:ring-primary/20 text-white placeholder:text-muted-foreground/30 px-6 pr-14 transition-all"
                                />
                                <button type="button" onClick={() => setShowConfirmPassword(!showConfirmPassword)} className="absolute right-5 top-1/2 -translate-y-1/2 text-muted-foreground/30 hover:text-primary transition-colors">
                        ...
                        <div className="relative flex items-center justify-center my-8">
                            ...
                            <span className="relative px-3 bg-[#0F1115] text-[10px] font-bold text-muted-foreground uppercase tracking-widest">or register with</span>
                        </div>
                ...
                <div className="block lg:hidden w-full max-w-[410px] space-y-6 relative z-10 animate-in fade-in slide-in-from-bottom-8 duration-700">
                    <div className="flex items-center justify-center gap-3 select-none">
                        <div className="w-11 h-11 rounded-xl bg-gradient-to-br from-primary via-purple-600 to-indigo-600 flex items-center justify-center border border-white/20 shadow-[0_0_15px_rgba(168,85,247,0.35)] relative overflow-hidden">
                            <div className="absolute inset-0 bg-gradient-to-tr from-white/10 to-transparent pointer-events-none" />
                            <span className="text-xl font-black text-white font-heading tracking-tighter drop-shadow-[0_2px_4px_rgba(0,0,0,0.3)]">S</span>
                        </div>
                        <div className="text-left">
                            <span className="font-black text-2xl tracking-wider text-white font-heading block leading-none">Script<span className="text-primary">Mind</span></span>
                            <span className="text-[8px] font-black text-muted-foreground uppercase tracking-widest leading-none mt-1.5 block">AI Genius Learning</span>
                        </div>
                    </div>
                    ...
                    <form onSubmit={handleRegister} className="space-y-4">
                        <div className="space-y-1.5 group">
                            <Label htmlFor="mobile-username" className="text-[10px] font-bold uppercase tracking-widest text-muted-foreground transition-colors group-focus-within:text-primary">Full Name</Label>
                            <div className="relative">
                        ...
                        <div className="space-y-1.5 group">
                            <Label htmlFor="mobile-email" className="text-[10px] font-bold uppercase tracking-widest text-muted-foreground transition-colors group-focus-within:text-primary">Email Address</Label>
                            <div className="relative">
                        ...
                        <div className="space-y-1.5 group">
                            <Label htmlFor="mobile-password" className="text-[10px] font-bold uppercase tracking-widest text-muted-foreground transition-colors group-focus-within:text-primary">Choose Password</Label>
                            <div className="relative">
                        ...
                        <div className="space-y-1.5 group">
                            <Label htmlFor="mobile-confirmPassword" className="text-[10px] font-bold uppercase tracking-widest text-muted-foreground transition-colors group-focus-within:text-primary">Confirm Password</Label>
                            <div className="relative">
                                <Lock className="absolute left-4 top-1/2 -translate-y-1/2 size-4.5 text-muted-foreground/45 transition-colors group-focus-within:text-primary" />
                                <Input
