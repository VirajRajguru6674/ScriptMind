            ...
            <div className="flex-1 flex items-center justify-center p-4 sm:p-8 relative min-h-screen overflow-y-auto bg-[#0F1115]">
                ...
                <div className="hidden lg:block w-full max-w-[440px] relative z-10 space-y-12 animate-in fade-in slide-in-from-right-8 duration-700">
                    ...
                    <form onSubmit={handleLogin} className="space-y-6">
                        ...
                        <div className="space-y-3 group">
                            <Label htmlFor="desktop-password" className="text-xs font-bold uppercase tracking-widest text-muted-foreground transition-colors group-focus-within:text-primary">Password</Label>
                            <div className="relative">
                                <Input
                                    id="desktop-password"
                        ...
                        <div className="flex items-center justify-between pb-2">
                            <div className="flex items-center space-x-3">
                                <Checkbox id="desktop-remember" className="rounded-md border-white/10 data-[state=checked]:bg-primary" />
                                <Label htmlFor="desktop-remember" className="text-sm font-medium text-muted-foreground cursor-pointer hover:text-white transition-colors">Keep me signed in</Label>
                            </div>
                        ...
                        <div className="relative flex items-center justify-center my-8">
                            ...
                            <span className="relative px-3 bg-[#0F1115] text-[10px] font-bold text-muted-foreground uppercase tracking-widest">or login with</span>
                        </div>
                ...
                <div className="block lg:hidden w-full max-w-[410px] space-y-6 relative z-10 animate-in fade-in slide-in-from-bottom-8 duration-700">
                    ...
                    <form onSubmit={handleLogin} className="space-y-4">
                        ...
                        <div className="space-y-1.5 group">
                            <Label htmlFor="mobile-password" className="text-[10px] font-bold uppercase tracking-widest text-muted-foreground transition-colors group-focus-within:text-primary">Password</Label>
                            <div className="relative">
                        ...
                        <div className="flex items-center justify-between pb-1">
                            <div className="flex items-center space-x-2">
                                <Checkbox id="mobile-remember" className="rounded-md border-white/10 data-[state=checked]:bg-primary size-4" />
                                <Label htmlFor="mobile-remember" className="text-xs font-semibold text-muted-foreground cursor-pointer hover:text-white transition-colors">Keep me signed in</Label>
                            </div>
